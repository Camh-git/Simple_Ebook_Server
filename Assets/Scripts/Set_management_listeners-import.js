...
function Assign_submit_actions() {
  ...
  //Manage thumbnails
  $("TH_select_form").bind("submit", (event) => {
    event.preventDefault();
    let Folder = event.target.children[2];
    let Book = event.target.children[5];
  ...
  $("TH_upload_form").bind("submit", (event) => {});
  $("TH_rename_form").bind("submit", (event) => {
    event.preventDefault();
  ...
  $("TH_format_form").bind("submit", (event) => {
    event.preventDefault();
  ...
  //Misc options
  $("DL_toggle_form").bind("submit", (event) => {
    event.preventDefault();
  ...
  $("Req_status_modal").bind("click", (event) => {
